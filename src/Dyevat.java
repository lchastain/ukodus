...
public class Dyevat extends JPanel implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if(e.getActionCommand() == "New") {
      ...
      clear();
      for(JLabel jl:squares) { jl.setToolTipText(null); }
    } // end if
  } // end actionPerformed
            ...
            if(strTmp.contains(String.valueOf(j))) {
              if(pendingReductions) {
                ...
                for(int hl=0; hl<9; hl++) { 
                  ...
                  if(getPosition(intInteractionType, boxIndices[theBox][hl]) == i) jlTmp.setBackground(Color.orange);
                } // end for
